...
app.service('contentService',function($http){
    ...
    this.findContentCategoryList = function(){
        return $http.get('http://localhost:8085/tbContentCategory/findAllCategory')
    }
    this.search = function (page,rows,searchEntity) {
		return $http.post('http://localhost:8085/tbContent/findAllContentPage?page='+page+'&rows='+rows)
	}
});
