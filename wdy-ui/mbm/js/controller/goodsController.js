app.controller('goodsController', function ($scope, $controller, goodsService, itemCatService, typeTemplateService, uploadService) {
    ...
    $scope.add = function () {
        ...
        /*$scope.entity.itemList = ItemJSON;
        $scope.entity.goodsDesc.specificationItems = specificationItemsArray);
        $scope.entity.goodsDesc.itemImages = itemImagesArray;
        $scope.entity.goodsDesc.customAttributeItems = customAttributeItemsArray;
        $scope.entity.goodsDesc.specificationItems = specificationItemsArray;
        $scope.entity.goodsDesc.itemImages = itemImagesArray;
        $scope.entity.goodsDesc.customAttributeItems = customAttributeItemsArray;
        $scope.entity.goodsDesc.introduction = editor.html();//富文本编辑器内容*/
    ...
    //查询一级商品分类
    $scope.selectItemCat1List = function (ling) {
        itemCatService.findByParentId(ling).success(function (response) {
