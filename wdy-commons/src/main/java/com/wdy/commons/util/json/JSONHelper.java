package com.wdy.commons.util.json;
...
private static final Logger logger = LoggerFactory.getLogger(JSONHelper.class);
    ...
    // 将JSON转换成数组,其中valueClz为数组中存放的对象的Classbr/>@SuppressWarnings("rawtypes")
    ...
    // 将JSON转换成POJO,其中beanClz为POJO的Classbr/>@SuppressWarnings("rawtypes")
...
// 遍历jsonObject数据，添加到Map对象
    ...
    /**
     ...
     "fffffffff"}br/>*/
    @SuppressWarnings("rawtypes")
    public static Map<String, List<Map<String, Object>>> json2MapList(
            String jsonStr) {
...
// 遍历jsonObject数据，添加到Map对象
    ...
    /***
     ...
     @return
     */
// 返回非实体类型(Map<String,Object>)的Listbr/>@SuppressWarnings("rawtypes")
